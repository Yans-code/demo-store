  ...
  function (t, e, i) {
    ...
    AFRAME.registerShader('gif', {
      ...
      tick: function (t) {
        this.__frames &&
          !this.paused() &&
          Date.now() - this.__startTime >= this.__nextFrameTime &&
          this.nextFrame()
      },
      ...
      __setTexure: function (t) {
        h('__setTexure', t),
          'error' === t.status
            ? (_('Error: ' + t.message + '\nsrc: ' + t.src), this.__reset())
            : 'success' === t.status &&
              t.src !== this.__textureSrc &&
              (this.__reset(), this.__ready(t))
      },
      __updateTexture: function (t) {
        ...
        'boolean' == typeof i
          ? (this.__autoplay = i)
          : 'undefined' == typeof i && (this.__autoplay = !0),
          this.__autoplay && this.__frames && this.play(),
          e
            ? this.__validateSrc(e, this.__setTexure.bind(this))
            : this.__reset()
      },
      __validateSrc: function (t, e) {
        ...
        if (o && 'object' === ('undefined' == typeof o ? 'undefined' : a(o))) {
          if (o.error) s = o.error
            ...
            if ('video' === _)
              (t = o.src), (s = 'For video, please use `aframe-video-shader`')
            else {
        ...
        if ('function' == typeof e) {
          ...
          i.open('GET', t),
            ...
            i.addEventListener('load', function (t) {
              for (
                var i = new Uint8Array(t.target.response),
                  r = i.subarray(0, 4),
                  a = '',
                  s = 0;
                s < r.length;
      ...
      if (
        ...
        for (var u = t.subarray(0, r); t[r] && 59 !== t[r]; ) {
          ...
          if (33 === l) {
            ...
            for (
              249 === f && a.push(10 * (t[r + 3] + (t[r + 4] << 8))),
                255 === f && (h = t[r + 15] + (t[r + 16] << 8));
              t[++r];
        ...
        var d = document.createElement('canvas'),
          m = function () {
            _.forEach(function (t, e) {
              ...
              ;(i.onload = function (t, e) {
                0 === e && ((d.width = i.width), (d.height = i.height)),
                  s++,
                  (_[e] = this),
                  s === _.length && ((s = 0), p(1))
              }.bind(i, null, e)),
          ...
          p = function g(t) {
            ...
            ;(i.onload = function (t, i) {
              s++,
                (_[i] = this),
                s === _.length ? ((d = null), e && e(a, h, _)) : g(++i)
            }.bind(i)),
